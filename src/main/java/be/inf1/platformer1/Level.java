...
public class Level {
    ...
    private void levelTest(int levelNumber) { // == de Level maker
        ...
        if (levelNumber == 4) {
            ...
            this.respawnCoordY = 340+150;
            
            blocks.add(new BlockPlatform(boardWidth-190, 350+150, 125, 20));    //beginplatform
            blocks.add(new BlockPlatform(boardWidth-183, 350+150-120, 125, 20));//test jump height
            
            blocks.add(new BlockJumpPad(boardWidth-275, 350+150-120, 80, 20));  //Boven Jump pad
            
            blocks.add(new BlockJumpPad(boardWidth-80, boardHeight-30, 80, 20));//recover jump pad als nodig
            blocks.add(new BlockPlatform(boardWidth-275+80, 350+150-120, 125+500, 20)); //Zodat speler ni te hoog vliegt
            ...
            blocks.add(new BlockLava(450, 350, 60, boardHeight-350));           // kolom 1
            blocks.add(new BlockLava(750, 80+150, 60, 600+260-(80+150)));       // kolom 2
            blocks.add(new BlockLava(1050, 50, 60, boardHeight-50));            // kolom 3
            blocks.add(new BlockLava(1350, 0, 60, 650+220-50));                 // kolom 4
            
            blocks.add(new BlockJumpPad(750, 80, 30, 150));                     //Wall JumpPad
            blocks.add(new BlockLava(750+30, 80, 60-30, 150));                  //Lava achter JumpPad
            blocks.add(new BlockLava(100, 80+150, 500, 120));                   //Onder deel lavaTunnel
            blocks.add(new BlockLava(0, 0, 750+60, 80));                        //Boven deel lavaTunnel
            blocks.add(new BlockPlatform(0, 80, 20, 120+150+200));              //Platform walljump
            
            blocks.add(new BlockLava(0, 550, 250, 20));                         //Lava voor finish
            blocks.add(new BlockPlatform(0, 550+20, 450, 20));                  //Exit Platform
            blocks.add(new ExitBlock(330, 550+20-40, 40, 40));                     //ExitBlock
            
            //blocks.add(new BlockJumpPad(450, boardHeight-125, 20, 125));      //Onder jump platform
